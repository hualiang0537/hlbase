...
<body>
	<ul data-role="listview" data-filter="true" data-filter-placeholder="搜索会议" data-inset="true">
		<c:forEach items="${list }" var="meet">
			<li><a href="${pageContext.request.contextPath }/meet/organize/meetdetail/${meet.id}"><fmt:formatDate value="${meet.begintime }" pattern="MM月dd日" /> ${meet.title }<br /><br />${meet.count }人报名 (<c:choose>
